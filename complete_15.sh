...
python3 train_2D_mult_auto_ver4.py "Huji_optical_flow_15_frame" $gpu "./data_pre/" "./folder5/" "x"
python3 train_2D_mult_auto_ver4.py "Huji_optical_flow_15_frame" $gpu "./data_pre/" "./folder5/" "y"

# Extract features from flow_x stream
ser_dir="./data_pre/Huji_optical_flow_30_frame"
name="S2"
type="x"
for e in "$ser_dir"/*
do
